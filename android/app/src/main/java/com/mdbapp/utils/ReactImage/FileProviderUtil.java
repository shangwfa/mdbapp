...
public class FileProviderUtil extends ContentProvider {
    ...
    private FileProviderUtil.PathStrategy mStrategy;
    ...
    public static Uri getUriForFile(@NonNull Context context, @NonNull String authority, @NonNull File file) {
        FileProviderUtil.PathStrategy strategy = getPathStrategy(context, authority);
        //Log.i("ImageFileProviderUtil",file.getName());
    ...
    private static FileProviderUtil.PathStrategy getPathStrategy(Context context, String authority) {
        synchronized(sCache) {
            FileProviderUtil.PathStrategy strat = (FileProviderUtil.PathStrategy)sCache.get(authority);
            if (strat == null) {
                try {
    ...
    private static FileProviderUtil.PathStrategy parsePathStrategy(Context context, String authority) throws IOException, XmlPullParserException {
        FileProviderUtil.SimplePathStrategy strat = new FileProviderUtil.SimplePathStrategy(authority);
    ...
    static class SimplePathStrategy implements FileProviderUtil.PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            while(true) {
                ...
                mostSpecific = root;
                Log.i("ImagemostSpecificUri", mostSpecific.toString());
            }
        }
