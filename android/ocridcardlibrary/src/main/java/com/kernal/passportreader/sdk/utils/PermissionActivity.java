...
public class PermissionActivity extends Activity {
	...
	public static final String[] PERMISSIONPICKER = new String[]{
			Manifest.permission.WRITE_EXTERNAL_STORAGE,//  Write access
			Manifest.permission.READ_EXTERNAL_STORAGE, //  read access
	...
	public static void startActivityForResult(Activity activity,Handler  sortOperaHandler1,
											  int requestCode, int nMainId, int nSubID,String devcode, int flag,
											  int VehicleLicenseflag,int nCropType, String imageTag,String... permission) {
		is_nMainId = nMainId;
		//is_nSubID = nSubID;
		is_devcode = devcode;
		is_flag = flag;
		...
		CardOcrRecogConfigure.getInstance()
				.initLanguage(activity.getApplication())
				.setSaveCut(true)
				.setnMainId(SharedPreferencesHelper.getInt(activity.getApplication(), "nMainId", nMainId))
				.setnSubID( SharedPreferencesHelper.getInt(activity.getApplication(), "nSubID", nSubID))
				.setFlag(0)
				.setnCropType(0)
				.setSavePath(new DefaultPicSavePath(activity.getApplication(),true,imageTag));
	...
	public static void startActivityForImagePickerResult(Activity activity,Handler sortOperaHandler1,int requestCode,String... permission){
